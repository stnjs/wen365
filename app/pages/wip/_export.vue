      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="card">
          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input v-model="exportOptions.dateRange.start" type="date" class="input-field" />
                </div>
                <div>
                  <label class="block text-xs text-gray-500 mb-1">To</label>
                  <input v-model="exportOptions.dateRange.end" type="date" class="input-field" />
                </div>
              </div>
            </div>
            ...
            <!-- Export Button -->
            <button @click="exportData" :disabled="isExporting" class="w-full btn-primary">
