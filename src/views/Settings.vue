    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="card mb-8">
        ...
        <div class="space-y-6">
          ...
          <!-- Tax-Free Period -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Tax-Free Period (Days)</label>
            <input 
          ...
          <!-- Currency -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Display Currency</label>
      ...
      <div class="card mb-8">
        ...
        <div class="space-y-6">
          ...
          <div>
            <label class="flex items-center">
              <input 
                ...
                class="rounded border-gray-300 text-primary-600 focus:ring-primary-500"
              >
              <span class="ml-2 text-sm font-medium text-gray-700">Telegram Notifications</span>
            </label>
            <p class="text-sm text-gray-500 mt-1 ml-6">
          ...
          <!-- Notification Timing -->
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">Notify Days Before</label>
            <select v-model.number="settings.notifications.notifyDaysBefore" class="input-field">
        ...
        <div class="space-y-4">
          <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
            <div>
              ...
              <div class="text-sm text-gray-500">Remove all stored portfolio and transaction data</div>
            </div>
            <button @click="clearAllData" class="btn-secondary text-red-600 hover:text-red-700">
              Clear Data
            </button>
          </div>
          ...
          <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
            <div>
              ...
              <div class="text-sm text-gray-500">Reset all settings to default values</div>
            </div>
      ...
      <!-- About -->
      <div class="card">
        <h2 class="text-xl font-semibold text-gray-900 mb-6">About HODLTracker</h2>
        
        <div class="space-y-4 text-sm text-gray-600">
          <p>
            HODLTracker helps you track your crypto holdings with FIFO logic for tax planning. 
            Perfect for users in countries with tax-free periods like Germany's 1-year rule.
          </p>
          <p>
            <strong>Version:</strong> 1.0.0<br>
            <strong>Built with:</strong> Vue 3, TypeScript, Tailwind CSS<br>
            <strong>Data Sources:</strong> Ethereum blockchain via Covalent/Alchemy APIs
          </p>
          <p>
